...
/**
 * Replaces DefaultLocatingElementHandler. Simply opens it up to descendants of
 * the WebElement interface, and other mix-ins of WebElement and Locatable, etc.
 * Saves the wrapping type for calling the constructor of the wrapped classes.
 * See https://github.com/elisarver/selophane/ for reference.
 */
public class ElementHandler implements InvocationHandler {
	 ...
	 *
	 * @param interfaceType
	 *            Interface wrapping this class. It contains a reference the the
	 *            implementation.
	 * @param locator
