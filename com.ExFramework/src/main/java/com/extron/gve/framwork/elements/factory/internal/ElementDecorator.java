 ...
 * does not. It is designed to support and return concrete implementations of
 * wrappers for a variety of common HTML elements. See
...
public class ElementDecorator implements FieldDecorator {
	...
	/**
	 * Constructor for an ElementLocatorFactory. This class is designed to replace
	...
	/**
	 * Generate a type-parameterized locator proxy for the element in question. We
	 * use our customized InvocationHandler here to wrap classes.
	 *
	 * @param loader
