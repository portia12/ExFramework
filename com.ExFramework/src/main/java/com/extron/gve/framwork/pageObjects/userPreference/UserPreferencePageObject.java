package com.extron.gve.framwork.pageObjects.userPreference;
...
@Component
public class UserPreferencesPageObject extends BasePageObject {

	@Autowired
	public UserPreferencesPageObject(WebDriver driver) {
		super(driver);
	}
