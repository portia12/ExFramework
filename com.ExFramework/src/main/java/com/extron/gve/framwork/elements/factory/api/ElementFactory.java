package com.extron.gve.framwork.elements.factory.api;
...
import com.extron.gve.framework.elements.factory.internal.ElementDecorator;

/**
 * Element factory for wrapped elements. Similar to
 * {@link org.openqa.selenium.support.PageFactory} See
...
public class ElementFactory {
	...
	/**
	 * As {@link ElementFactory#initElements(org.openqa.selenium.WebDriver, Class)}
	 * but will only replace the fields of an already instantiated Page Object.
	 * 
	 * @param searchContext
	 *            A search context that will be used to look up the elements
	 * @param page
	 *            The object with WebElement and List<WebElement> fields that should
	 *            be proxied.
	...
	/**
	 * See
	 * {@link org.openqa.selenium.support.PageFactory#initElements(org.openqa.selenium.WebDriver
	 * driver, Class)}
	 */
